...
MAX_DATA  = 1004
MAX_RESND = 3
RTO       = 2      #The retransmission time period
...
#-------------------#
#Connection Set Up
	def connect(self, ipAddr = '127.0.0.1', portNum = RCV_PORT): #HARDCODING for default address
		self.pktId   = 0
	...
	#LISTEN
		...
		while True:
			try:
				...
				print 'END_TIME_OUT'
				raise END_TIME_OUT
			except WRONG_TYPE: continue
			else:
				self.pktId = self.recvData[1]
				break 
